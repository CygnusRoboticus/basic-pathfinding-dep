...
var Pathfinding = /** @class */ (function () {
    ...
    Pathfinding.findWalkable = function (grid, coords, costThreshold) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, startX, startY, search;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        coords = coords instanceof Array ? coords : [coords];
                        _a = coords[0], startX = _a.x, startY = _a.y;
                        search = new search_1.default({
                            costThreshold: costThreshold,
                            startX: startX,
                            startY: startY
                        ...
                        coords.forEach(function (_a) {
                            var x = _a.x, y = _a.y;
                            var node = Pathfinding.coordinateToNode(search, null, x, y, 0);
                            search.push(node);
                        });
                        return [4 /*yield*/, Pathfinding.calculate(search, grid)];
                    case 1:
