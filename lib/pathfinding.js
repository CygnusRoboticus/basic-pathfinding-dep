...
var Pathfinding = /** @class */ (function () {
    ...
    Pathfinding.findPath = function (grid, startX, startY, endX, endY, costThreshold) {
        return __awaiter(this, void 0, void 0, function () {
            var search, startNode, node, path, parent;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Pathfinding.calculate(grid, search)];
                    case 1:
                        _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        nodes = [];
                        search.nodeCache.forEach(function (map, y) {
    ...
    Pathfinding.calculate = function (grid, search) {
        while (true) {
            //fully traversed
    ...
    Pathfinding.checkAdjacentNode = function (grid, search, sourceNode, x, y) {
