...
export default class Pathfinding {
    ...
    static checkAdjacentNode(grid: Grid, instance: Search, sourceNode: Node, x: number, y: number): void;
    static canAfford(sourceNode: Node, cost: number, costThreshold?: number): boolean;
    static coordinateToNode(instance: Search, parent: Node | null, x: number, y: number, cost: number): Node;
